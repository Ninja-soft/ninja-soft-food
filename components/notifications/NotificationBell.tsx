      ...
      <div className="mt-2 flex items-center gap-2">
        {n.action_url && (
          <button
            ...
            className="rounded-md bg-primary/15 px-2.5 py-1 text-xs font-medium text-primary transition hover:bg-primary/25"
          >
            {n.action_label ?? "Ver"}
          </button>
        )}
    ...
    <Popover.Root open={open} onOpenChange={setOpen}>
      ...
      <Popover.Portal>
        <Popover.Content
          align="end"
          sideOffset={8}
          className="z-50 w-[380px] overflow-hidden rounded-lg border border-border bg-popover text-popover-foreground shadow-soft backdrop-blur-xl data-[state=open]:animate-fade-in"
        >
