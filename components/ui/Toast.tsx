...
const VARIANT = {
  ...
  info: { icon: Info, ring: "ring-primary/25", iconCls: "text-primary" },
} as const;
        ...
        {items.map((item) => {
          ...
          return (
            <ToastPrimitive.Root
              ...
              className={cn(
                "group pointer-events-auto flex items-start gap-3 rounded-lg border border-border bg-popover/95 p-3.5 pr-9 text-popover-foreground shadow-soft ring-1 backdrop-blur-xl",
