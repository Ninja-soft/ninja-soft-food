...
// Port 1:1 del POS (components/ui/ChangePasswordModal). Genérico (solo Supabase
// Auth), sin dependencias del esquema. Blanqueo por email apunta a
// /reset-password (ruta existente en Food: app/(auth)/reset-password).
