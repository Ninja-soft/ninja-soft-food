  ...
  return (
    <>
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">
        Enviá avisos in-app a los negocios. Llegan a la campana de la app de los
        usuarios alcanzados.
      </p>
      ...
      <Card className="mt-6 space-y-5 p-5">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-input bg-background p-3 text-sm text-foreground outline-none transition placeholder:text-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="h-10 rounded-lg border border-input bg-background px-3 text-sm text-foreground outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
        </div>
