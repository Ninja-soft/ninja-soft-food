...
// =============================================================================
// app/api/cron/reconcile-billing — reconciliación diaria del cobro.
//
...
//
// Schedule (vercel.json): "17 6 * * *" UTC ≈ 03:17 AR (UTC-3). runtime nodejs:
// service_role + fetch a MP, jamás edge/cliente.
// =============================================================================
