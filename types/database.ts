  ...
  public: {
    Tables: {
      ...
      internal_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "internal_settings_updated_by_fkey"
            columns: ["updated_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      manual_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "manual_payments_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      subscription_addons: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscription_addons_addon_key_fkey"
            columns: ["addon_key"]
            isOneToOne: false
      ...
      tenant_flags: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_flags_set_by_fkey"
            columns: ["set_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tenant_flags_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
