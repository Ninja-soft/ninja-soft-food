...
import { DOT, buildEmailLayout } from "@/lib/emails/templates";
import { formatDate, formatQty } from "@/lib/utils/format";

// =============================================================================
// lib/crons/jobs/stock-alerts — núcleo de las alertas diarias de stock.
//
...
// resto. Sin autorización ni respuesta HTTP: lo invocan el route handler
// (/api/cron/stock-alerts, disparo manual) y /api/cron/daily.
// =============================================================================
...
export async function runStockAlerts(): Promise<Summary> {
  ...
  if (tenantsErr) {
    return { processed: 0, errors: [`tenants_query: ${tenantsErr.message}`] };
  }
