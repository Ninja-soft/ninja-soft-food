...
// Port 1:1 del AppearanceProvider del POS, con acentos en clave Food.
...
export type PriceAccent = "marca" | "bosque" | "lima" | "miel" | "berry" | "neutro";

// Degradado de resalte para números (kg, lotes, montos). "neutro" = color del tema.
...
// Anti-FOUC: aplica fuentes/fondo/acento antes de la hidratación (patrón POS).
...
(function(){
  try{
    ...
    var t=localStorage.getItem('ninja-food-theme');
    var ts=['food-dark','food-light','food-bosque','food-crema','food-remolacha','food-mar'];
    if(ts.indexOf(t)!==-1){r.setAttribute('data-theme',t);}
  }catch(e){
