...
| --------------------- | ----- | ---------- | ---------- | --------- | ---------------- | ----------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------- |
| `food-dark` (default) | dark  | `#0A1411`  | `#F0F7F3`  | `#22C55E` | `#6EE7B7` (menta) | `rgba(255,255,255,.06)` | `rgba(255,255,255,.10)` | Menta esmeralda: negro con tinte menta frío (lee sanidad/frescura, bien distinto del verde selva de Bosque); radiales esmeralda/menta sobre `linear-gradient(135deg,#06110E,#0A211A,#0F3527)` |
